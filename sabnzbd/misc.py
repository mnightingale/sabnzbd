...
from typing import Union, Any, AnyStr, Optional, Collection, Generator
...
@contextmanager
def acquire_timeout(lock: Union[threading.RLock, threading.Lock], timeout: float) -> Generator[bool, Any, None]:

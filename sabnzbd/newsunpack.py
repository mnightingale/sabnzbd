...
def unpacker(
    ...
    if depth == 1:
        ...
        xjoinables, xrars, xsevens, xts, xtars = build_filelists(
            nzo.download_path, extra_dirs=nzo.relocated_directories()
        )
    else:
        xjoinables, xrars, xsevens, xts, xtars = build_filelists(
            nzo.download_path, workdir_complete, check_both=nzo.delete, extra_dirs=nzo.relocated_directories()
        )
    ...
    if (
        ...
        and nzo.delete
        and depth == 1
        and any(build_filelists(nzo.download_path, extra_dirs=nzo.relocated_directories()))
    ):
        force_rerun = True

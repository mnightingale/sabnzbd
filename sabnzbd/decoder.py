...
def decode(article: Article, decoder: sabctools.NNTPResponse):
    ...
    try:
        ...
        instrumentation.count_labelled("decoder.written", "sink-failed")
    ...
    if decoded_data:
        ...
        if article_success and article.decoded_size:
            instrumentation.count("decoder.articles")
            instrumentation.count("decoder.bytes", article.decoded_size)
            instrumentation.count_labelled("decoder.written", "streamed")
